...
public class bucketWidthUpgrader : upgrader
{
    ...
    void Start()
    {
        ...
        current_level = PlayerPrefs.GetInt("bucketWidthLevel",0);
        updateCostText();
    ...
    void Update()
    {
        ...
        if (current_level != PlayerPrefs.GetInt("bucketWidthLevel",0))
        {
            updateCostText();
            PlayerPrefs.SetInt("bucketWidthLevel",current_level);
        }
        ...
        PlayerPrefs.SetFloat("bladeScale",1f+(value_incriment_per_level * current_level));
